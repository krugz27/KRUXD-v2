...
const $$WorkLogin = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Work Access | KRUXD", "currentPath": "/work", "data-astro-cid-g3ncwfns": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<nav class="breadcrumbs" aria-label="Breadcrumb" data-astro-cid-g3ncwfns> <a href="/" data-astro-cid-g3ncwfns>Home</a> <span class="crumb-sep" aria-hidden="true" data-astro-cid-g3ncwfns>/</span> <span aria-current="page" data-astro-cid-g3ncwfns>Work Access</span> </nav> <section class="hero compact" data-astro-cid-g3ncwfns> <p class="eyebrow" data-astro-cid-g3ncwfns>Protected Work</p> <h1 data-astro-cid-g3ncwfns>Enter Password</h1> <p data-astro-cid-g3ncwfns>Featured work summaries remain public. Full Work pages require a password.</p> </section> <section class="section detail" data-astro-cid-g3ncwfns> <form class="work-login-form" method="post" action="/api/work-auth/login" data-astro-cid-g3ncwfns> <input type="hidden" name="next"${addAttribute(nextPath, "value")} data-astro-cid-g3ncwfns> <label class="work-login-label" for="work-password" data-astro-cid-g3ncwfns>Work Password</label> <input id="work-password" class="work-login-input" type="password" name="password" autocomplete="current-password" required data-astro-cid-g3ncwfns> ${hasIncorrectPasswordError && renderTemplate`<p class="work-login-error" role="alert" data-astro-cid-g3ncwfns>
...
</p>`} <div class="work-login-actions" data-astro-cid-g3ncwfns> <button type="submit" class="work-login-submit" data-astro-cid-g3ncwfns>Unlock Work</button> <a href="/" class="work-login-cancel" data-astro-cid-g3ncwfns>Back Home</a> </div> </form> </section> ` })} `;
