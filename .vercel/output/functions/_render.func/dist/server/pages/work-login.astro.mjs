...
import 'piccolore';
import { $ as $$BaseLayout } from '../chunks/BaseLayout_DL8GCOeU.mjs';
...
</p>`} <div class="work-login-actions" data-astro-cid-g3ncwfns> <button type="submit" class="work-login-submit" data-astro-cid-g3ncwfns>View Case Studies</button> <a href="/" class="work-login-cancel" data-astro-cid-g3ncwfns>Return to Home</a> </div> </form> ${isLocalDev} </section> ` })} `;
